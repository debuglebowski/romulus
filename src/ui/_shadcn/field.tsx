...
function FieldTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="field-label"
      className={cn(
        "gap-2 text-[11px] uppercase tracking-[1px] font-medium group-data-[disabled=true]/field:opacity-50 flex w-fit items-center leading-snug",
        className
      )}
      {...props}
    />
...
function FieldError({
  ...
  return (
    <div
      ...
      className={cn("text-[color:var(--danger-text)] text-[11px] font-normal", className)}
      {...props}
    >
      {content}
    </div>
