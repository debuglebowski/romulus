...
import { Card, CardAction, CardContent, CardDescription, CardFooter, CardHeader, CardTitle } from '../_shadcn/card';
import { Combobox, ComboboxContent, ComboboxEmpty, ComboboxInput, ComboboxItem, ComboboxList } from '../_shadcn/combobox';
import {
	DropdownMenu,
...
import { Field, FieldGroup, FieldLabel } from '../_shadcn/field';
import { Input } from '../_shadcn/input';
import { Select, SelectContent, SelectGroup, SelectItem, SelectTrigger, SelectValue } from '../_shadcn/select';
		...
		<Example title='Card' className='items-center justify-center'>
			<Card className='relative w-full max-w-sm overflow-hidden pt-0'>
				...
				<CardHeader>
					...
					<CardDescription>
						Switch to the improved way to explore your data, with natural language. Monitoring will no longer be available on the Pro plan
						in November, 2025
					</CardDescription>
				</CardHeader>
				<CardFooter>
